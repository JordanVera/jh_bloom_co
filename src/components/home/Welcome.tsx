...
import { ABOUT_CONTENT, COMPANY, WELCOME } from '@/lib/data';
      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-[1fr_2fr] gap-12 md:gap-16 items-start">
          <motion.div {...anim(0)} className="flex flex-col gap-4">
            <span className="text-[#d48a96] text-[10px] tracking-[0.35em] uppercase">
              Welcome
            </span>
          ...
          <div className="flex flex-col gap-6">
            ...
            >
              {WELCOME.heading}{' '}
              <em className="italic text-[#d48a96]">{WELCOME.emphasis}</em>
            </motion.h2>
            ...
            <motion.div {...anim(0.5)}>
              <Link
                href="/about"
                className="inline-flex items-center text-[#d48a96] text-xs tracking-[0.2em] uppercase hover:underline underline-offset-4"
              >
                Meet the Designer
              </Link>
            </motion.div>
