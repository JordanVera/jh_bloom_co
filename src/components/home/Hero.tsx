    ...
    >
      ...
      >
        <motion.p
          ...
          className="mb-6 text-xs tracking-[0.4em] text-[#d48a96] uppercase"
        >
          {HERO.kicker}
        </motion.p>
        ...
        >
          {HERO.titleBefore}{' '}
          <em className="italic text-[#d48a96]">{HERO.titleEmphasis}</em>
        </motion.h1>
        ...
        >
          <Link
            href="/contact"
            className="bg-[#d48a96] px-8 py-3.5 text-xs font-medium tracking-[0.2em] text-black uppercase transition-colors duration-200 hover:bg-[#e5a3ad]"
          >
            Get in Touch
          </Link>
          <Link
            href="/portfolio"
            className="border border-white/50 px-8 py-3.5 text-xs tracking-[0.2em] text-white uppercase transition-all duration-200 hover:border-[#d48a96] hover:text-[#d48a96]"
          >
            View Portfolio
          </Link>
        </motion.div>
